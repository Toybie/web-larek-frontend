...
class App {
    ...
    constructor() {
        ...
        this.basketModal = new BasketModal(this.modal);
        this.basket = new Basket(basketButton, basketCounter, this.basketModal);
        ...
        this.catalog = new Catalog(catalogContainer, this.basket);
